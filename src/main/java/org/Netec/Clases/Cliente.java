...
public class Cliente implements ServicioCuentas, Comparable<Cuenta> {
    ...
    public Cliente(int numero, String nombre, Domicilio domicilio, String rfc, String telefono, String cuentas, String fechaNacimiento) {
        this.numero = numero;
        this.nombre = nombre;
...
//    public Cliente(int i, String deybi) {
//    }
    ...
    public void setCuentas(ArrayList<Cuenta> cuentas) {
        this.cuentas = String.valueOf(cuentas);
    }
